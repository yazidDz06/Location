...
export default function Footer(){
    return(
      ...
      <div className="max-w-screen-xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href="" className="text-slate-400 hover:text-white text-sm">Featured</a>
              </li>
              <li>
                <a href="" className="text-slate-400 hover:text-white text-sm">New Arrivals</a>
              </li>
              <li>
                <a href="" className="text-slate-400 hover:text-white text-sm">New Arrivals</a>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a href="" className="text-slate-400 hover:text-white text-sm">Terms &amp; Conditions</a>
              </li>
              <li>
                <a href="" className="text-slate-400 hover:text-white text-sm">Privacy Policy</a>
              </li>
              <li>
                <a href="" className="text-slate-400 hover:text-white text-sm">Sale</a>
              </li>
              <li>
        ...
        <p className="text-slate-400 text-sm mt-10">© RCarsAlgeria 2025.
        </p>
      </div>
    </footer>
    )
